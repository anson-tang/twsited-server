...
def constant_data():
    constant_data = {
            ...
            'MAX_COMMON_RADIUS': MAX_COMMON_RADIUS,
            'MAX_USER_COUNT': MAX_USER_COUNT,
            'MAX_USERBALL_COUNT': MAX_USERBALL_COUNT,
            'REFRESH_INTERVAL_FOODBALL': REFRESH_INTERVAL_FOODBALL,
            'REFRESH_INTERVAL_SPINEBALL': REFRESH_INTERVAL_SPINEBALL,
            'PVP_SECONDS': PVP_SECONDS,
            'INIT_USERBALL_VOLUME': INIT_USERBALL_VOLUME,
            'INIT_FOODBALL_VOLUME': INIT_FOODBALL_VOLUME,
            'INIT_SPINEBALL_VOLUME': INIT_SPINEBALL_VOLUME,
        }
